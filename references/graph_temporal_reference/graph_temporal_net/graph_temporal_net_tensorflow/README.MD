This is a TensorFlow implementation of GraphTemporalNet: A Temporal Graph Convolutional Network for Traffic Prediction.
...
The GraphTemporalNet model was in the graph_temporal_net.py
