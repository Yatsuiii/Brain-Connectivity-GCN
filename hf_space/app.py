...
_ATLAS_CFG = {
    ...
    "aal": {
        ...
        "ckpts": {
            "CALTECH":  Path("checkpoints/aal_caltech.ckpt"),
            "CMU":      Path("checkpoints/aal_cmu.ckpt"),
            "KKI":      Path("checkpoints/aal_kki.ckpt"),
            "LEUVEN_1": Path("checkpoints/aal_leuven_1.ckpt"),
            "LEUVEN_2": Path("checkpoints/aal_leuven_2.ckpt"),
            "MAX_MUN":  Path("checkpoints/aal_max_mun.ckpt"),
            "NYU":      Path("checkpoints/aal_nyu.ckpt"),
            "OHSU":     Path("checkpoints/aal_ohsu.ckpt"),
            "OLIN":     Path("checkpoints/aal_olin.ckpt"),
            "PITT":     Path("checkpoints/aal_pitt.ckpt"),
            "SBL":      Path("checkpoints/aal_sbl.ckpt"),
            "SDSU":     Path("checkpoints/aal_sdsu.ckpt"),
            "STANFORD": Path("checkpoints/aal_stanford.ckpt"),
            "TRINITY":  Path("checkpoints/aal_trinity.ckpt"),
            "UCLA_1":   Path("checkpoints/aal_ucla_1.ckpt"),
            "UCLA_2":   Path("checkpoints/aal_ucla_2.ckpt"),
            "UM_1":     Path("checkpoints/aal_um_1.ckpt"),
            "UM_2":     Path("checkpoints/aal_um_2.ckpt"),
            "USM":      Path("checkpoints/aal_usm.ckpt"),
            "YALE":     Path("checkpoints/aal_yale.ckpt"),
        },
    },
    "ho": {
        "n_rois":      111,
